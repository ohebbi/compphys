...
\begin{figure}[H]
  ...
  \caption{The Earth in a circular orbit around the origin (the sun) with intial velocity $\mathbf{v}=(0, 2\pi)$ in positive vertical direction. This is done by using Veilet's algorithm with $10^6$ integration points.}
  \label{jordensbane}
\end{figure}
