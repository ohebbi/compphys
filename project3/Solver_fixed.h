...
vector<double> instal(vector<double> C, vector<Planet*> planets, int in){
        ...
        double ax1 = C[2]*(first->pos[0]/r+f[0]);
        double ay1 = C[2]*(first->pos[1]/r+f[1]);
        double az1 = C[2]*(first->pos[2]/r+f[2]);
...
vector<double> get_pos(vector<Planet*> planets, int in, vector<double> C){
	    ...
	    double ax = C[2]*(p->pos[0]/r+f[0]);
        p->pos[3] += C[4]*(ax+p->pos[6]);

        double ay = C[2]*(p->pos[1]/r+f[1]);
        p->pos[4] += C[4]*(ay+p->pos[7]);

        double az = C[2]*(p->pos[2]/r+f[2]);
